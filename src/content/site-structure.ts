...
export const heroContent: HeroContent = {
  ...
  title: "Поймите бюджет, список работ и сроки ремонта до разговора с мастером",
  description:
    "Выберите помещения, работы и уровень материалов. Сервис соберет предварительный расчет, этапы ремонта и ссылку, которую можно отправить мастеру или семье.",
  ...
  stats: [
    {
      ...
      value: "Смета-диапазон",
      note: "Без фальшивой одной цены",
    },
    {
...
export const landingSections: LandingSection[] = [
  ...
  },
  {
    ...
    description:
      "В MVP лучше сразу показывать полный понятный перечень, чтобы пользователь не гадал, есть ли нужный ему тип работ.",
    items: [
      "Демонтаж и вывоз",
      "Сантехника",
      "Электрика",
  ...
  },
  {
    ...
    description:
      "Примеры нужны не как прайс-лист, а как якорь доверия: человек видит диапазон и понимает масштаб проекта.",
    items: [
      {
        title: "Кухня 12 м²",
  ...
  },
  {
    ...
    description:
      "Сайт не обещает невозможную точность. Он помогает заранее увидеть объем работ, диапазон цены и причины, из-за которых итог может измениться.",
    items: [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Да. В результате формируется ссылка с тем же набором выбора, чтобы мастер видел одинаковый список работ.",
      },
      {
